...
[[
  ...
  'w', 'w', 'w', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'b', 'x', 'x', 'e', 'w',
  'w', 'x', 'x', 'x', 'x', 't', 'y', 't', 'k', 'w', 't', 'w', 't', 't', 'w',
  'w', 'w', 't', 'x', 'w', 'w', 'w', 'x', 'x', 't', 'x', 'x', 'x', 'y', 'w',
  ...
  'w', 'z', 'x', 'x', 't', 'y', 'w', 'w', 'x', 's', 'y', 'w', 'w', 'x', 'w',
  'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w',
],[
  'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w',
  'w', 'x', 'x', 'x', 'x', 'w', 'w', 't', 'w', 't', 'z', 't', 'w', 'w', 'w',
  'w', 'k', 'w', 't', 'y', 'x', 'x', 'x', 'x', 'w', 'x', 'x', 't', 'w', 'w',
  ...
  'w', 'y', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'w', 't', 'w', 'x', 'x', 'w',
  'w', 'x', 'x', 'w', 'w', 't', 'w', 'w', 'x', 'x', 'x', 'x', 'w', 'x', 'w',
  'w', 'e', 'x', 't', 'w', 'w', 's', 'x', 'x', 'w', 'w', 'y', 'x', 'x', 'w',
  'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w',
],[
  'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w', 'w',
  'w', 'y', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'y', 'w', 'x', 'x', 'z', 'w',
